                    ...
                    <Row className="pt-3 pb-5 align-items-center">
                        ...
                        <Col xs={12} md={6}>
                            <Row className=" align-items-start p-2 my-details rounded">
                                ...
                                <br />
                                My goal is always driven towards providing amazing experience with the best level of quality of my service.
                                <br />
                            ...
                            <Row>
                                ...
                                <Col className="d-flex justify-content-center flex-wrap">
                                    ...
                                    <div>
                                        <a href="https://drive.google.com/file/d/1b2z7qpolUZ0P6KhybXecGCYBSt1yThJs/view?usp=sharing" target="_blank" rel="noopener noreferrer">
